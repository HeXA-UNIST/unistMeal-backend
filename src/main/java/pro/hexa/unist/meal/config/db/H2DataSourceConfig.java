...
public class H2DataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setJdbcUrl("jdbc:h2:mem:mexa_meal;INIT=CREATE SCHEMA IF NOT EXISTS hexa_meal;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
        return dataSource;
    }
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.default_catalog", "hexa_meal");
